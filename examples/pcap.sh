...
#
# When run by peapod as it proxies an EAPOL message, write the Ethernet
# frame containing the message, as originally received, to a .pcap file.
#
# See env.sh for more on environment variables available to scripts.
#
